...
@interface SlidingMenuGrid : CCLayer
{
	...
	// Padding in between menu items. point is base on the original point
	CGPoint padding;
	...
	int iPageCount; // Number of pages in this grid.,start by 0
	int iCurrentPage; // Current page of menu items being viewed.start by 0
...
@property (nonatomic, readwrite) float menuRows;
@property (nonatomic, readwrite) float menuCols;
